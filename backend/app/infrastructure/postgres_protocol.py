...
class PostgresRepositoryProtocol(Protocol):
    ...
    def create_arca_request(self, *, invoice_id: int, operation: str, environment: str, sanitized_request: dict[str, object], issuer_cuit: str | None = None, point_of_sale: int | None = None, cbte_tipo: int | None = None, cbte_number: int | None = None, idempotency_key: str | None = None, soap_action: str | None = None, retry_of: int | None = None, status: str = "pending", sanitized_response: dict[str, object] | None = None, error_code: str | None = None, error_message: str | None = None) -> int: ...
