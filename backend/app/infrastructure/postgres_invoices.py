    ...
    def save_invoice(
        ...
        *,
        ...
        invoice_payload = {
            ...
            "batch_id": batch_id,
            "legacy_key": f"invoice:{created_at.timestamp():.6f}:{document_type or 'FACTURA'}:{order['client_name']}",
        ...
        with self.engine.begin() as connection:
            ...
            for doc in invoices:
                ...
                invoice_payload = {
                    ...
                    "legacy_key": f"invoice:{created_at.timestamp():.6f}:{document_type}:{order['client_name']}:{doc.get('split_kind')}",
                    "document_type": document_type,
                    "point_of_sale": point_of_sale,
                    "invoice_number": None,
