...
def build_metadata() -> tuple[MetaData, dict[str, Table]]:
    ...
    tables = {
        ...
        "price_list_versions": Table(
            ...
            Column("content_type", String(120), nullable=False),
            Column("size", Integer, nullable=False),
            Column("pdf_sha256", String(64), nullable=False, unique=True),
            Column("pdf_data", LargeBinary, nullable=False),
            Column("source", String(120), nullable=False),
            Column("catalog_snapshot", JSONB, nullable=False),
            Column("uploaded_at", DateTime(timezone=True), nullable=False),
            CheckConstraint("version_number > 0", name="ck_price_list_versions_version_positive"),
            CheckConstraint("char_length(btrim(name)) > 0", name="ck_price_list_versions_name_not_blank"),
        ...
        "arca_iva_conditions": Table(
            "arca_iva_conditions",
            metadata,
            Column("arca_id", Integer, primary_key=True),
            Column("description", String(255), nullable=False),
            Column("normalized_description", String(255), nullable=False, unique=True),
            Column("enabled", Boolean, nullable=False, server_default="true"),
            Column("valid_from", Date),
            Column("last_seen_at", DateTime(timezone=True), nullable=False),
            CheckConstraint("arca_id > 0", name="ck_arca_iva_conditions_id_positive"),
            CheckConstraint("char_length(btrim(description)) > 0", name="ck_arca_iva_conditions_description_not_blank"),
            CheckConstraint("char_length(btrim(normalized_description)) > 0", name="ck_arca_iva_conditions_normalized_not_blank"),
        ),
        "invoices": Table(
            "invoices",
            metadata,
            ...
            Column("customer_iva_condition", String(120), nullable=False, server_default=""),
            Column("customer_fiscal_snapshot", JSONB),
            ...
            CheckConstraint("fiscal_status IN ('internal', 'draft', 'authorizing', 'authorized', 'authorized_homologation', 'authorization_failed', 'rejected', 'error')", name="ck_invoices_fiscal_status_valid"),
            ...
            CheckConstraint("char_length(customer_iva_condition) <= 120", name="ck_invoices_customer_iva_condition_max_length"),
        ...
        "credit_note_item_sources": Table(
            ...
            metadata,
            Column("id", BigInteger, primary_key=True, autoincrement=True),
            Column("credit_note_invoice_id", BigInteger, ForeignKey("invoices.id", ondelete="CASCADE"), nullable=False),
            Column("credit_note_item_id", BigInteger, ForeignKey("invoice_items.id", ondelete="CASCADE"), nullable=False),
            Column("source_invoice_id", BigInteger, ForeignKey("invoices.id", ondelete="CASCADE"), nullable=False),
            Column("source_invoice_item_id", BigInteger, ForeignKey("invoice_items.id", ondelete="CASCADE"), nullable=False),
            Column("quantity", Numeric(12, 2), nullable=False),
            Column("created_at", DateTime(timezone=True), nullable=False),
            CheckConstraint("quantity > 0", name="ck_credit_note_item_sources_quantity_positive"),
            UniqueConstraint("credit_note_item_id", "source_invoice_item_id", name="uq_credit_note_item_sources_credit_source"),
        ),
        "arca_requests": Table(
            "arca_requests",
            metadata,
            ...
            Column("issuer_cuit", String(32)),
            Column("point_of_sale", Integer),
            Column("cbte_tipo", Integer),
            Column("cbte_number", BigInteger),
            Column("idempotency_key", String(120)),
            Column("soap_action", String(120)),
            Column("retry_of", BigInteger, ForeignKey("arca_requests.id", ondelete="SET NULL")),
            ...
            CheckConstraint("point_of_sale IS NULL OR point_of_sale > 0", name="ck_arca_requests_point_of_sale_positive"),
            CheckConstraint("cbte_number IS NULL OR cbte_number > 0", name="ck_arca_requests_cbte_number_positive"),
            CheckConstraint("char_length(btrim(request_hash)) > 0", name="ck_arca_requests_request_hash_not_blank"),
            CheckConstraint("status IN ('pending', 'authorized', 'rejected', 'authorization_failed', 'error')", name="ck_arca_requests_status_valid"),
            Index("uq_arca_requests_reserved_number", "environment", "issuer_cuit", "point_of_sale", "cbte_tipo", "cbte_number", unique=True, postgresql_where=text("cbte_number IS NOT NULL")),
        ),
        "app_users": Table(
            "app_users",
            metadata,
